  ...
  const generateBotResponse = async (history) => {
    ...
    const requestOptions = {
      ...
      headers: {
        ...
        "Authorization": `Bearer ${import.meta.env.VITE_SILICONFLOW_API_KEY}`, // 你的 API Key
      },
      body: JSON.stringify({
        model: "deepseek-ai/DeepSeek-V2.5",  // 硅基流动 API 需要 DeepSeek-V2.5
        messages: messages,
        stream: false,  // 关闭流式传输（如果需要流式响应，需要处理 SSE）
      }),
    };
